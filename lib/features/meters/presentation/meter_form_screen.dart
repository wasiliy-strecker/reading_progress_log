...
class _MeterFormState extends ConsumerState<_MeterForm>
  ...
  void initState() {
    ...
    _type = meter?.type ?? MeterType.knitting;
    ...
    return PopScope<void>(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(editing ? 'Projekt bearbeiten' : 'Projekt anlegen'),
        ),
        body: Form(
          key: _formKey,
          child: ListView(
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  ...
                  hintText: 'z. B. Mein Salbei-Pullover',
                ),
              ...
              TextFormField(
                controller: _number,
                decoration: const InputDecoration(
                  labelText: 'Garn (optional)',
                  hintText: 'z. B. Merinowolle, Salbei',
                ),
                textInputAction: TextInputAction.next,
              ),
              const SizedBox(height: 14),
              TextFormField(
                ...
                decoration: const InputDecoration(
                  labelText: 'Nadelstärke (optional)',
                  hintText: 'z. B. 4,5 mm',
                ),
                textInputAction: TextInputAction.next,
              ),
                  ...
                  child: Column(
                    children: [
                      SwitchListTile(
                        ...
                        title: const Text('Projekterinnerung'),
                        subtitle: const Text(
  ...
  Future<void> _handleBack() async {
    ...
    final discard = await confirmDiscardChanges(
      ...
      message: editing
          ...
          : 'Deine Eingaben für das neue Projekt wurden noch nicht gespeichert.',
              ...
              child: Text.rich(
                TextSpan(
                  children: [
                    ...
                    const TextSpan(
                      text:
                          ' deinen ersten Projektstand erfassen und protokollieren.',
                    ),
                  ],
                ),

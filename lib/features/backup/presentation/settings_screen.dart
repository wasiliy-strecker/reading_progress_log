                    ...
                    child: Column(
                      children: [
                        ListTile(
                          ...
                          subtitle: const Text(
                            'Projekte, Fotos, Projektprotokolle und Korrekturverläufe',
                          ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const ListTile(
                          ...
                          title: Text('Open Source · MPL 2.0'),
                        ),
                      ],
                    ),
                  ),
          ...
          builder: (context) => AlertDialog(
            ...
            content: Column(
              ...
              children: [
                ...
                Text(
                  '${_countLabel(backup.preview.meterCount, 'Projekt', 'Projekte')} · '
                  '${_countLabel(backup.preview.readingCount, 'Projektstand', 'Projektstände')} · '
                  '${_countLabel(backup.preview.exportCount, 'Projektprotokoll', 'Projektprotokolle')}\n'
    ...
    try {
      ...
      _showMessage(switch (error.failure) {
        BackupFilePickFailure.invalidExtension =>
          'Bitte wähle eine Strick & Häkelbuch-Backup-Datei (.shbackup).',
      ...
      final confirmed =
          await showDialog<bool>(
            ...
            builder: (context) => AlertDialog(
              title: const Text('Backup wiederherstellen?'),
              content: Text(
                '${_countLabel(preview.meterCount, 'Projekt', 'Projekte')}, ${_countLabel(preview.readingCount, 'Projektstand', 'Projektstände')} und ${_countLabel(preview.exportCount, 'Projektprotokoll', 'Projektprotokolle')} werden importiert. Neuere lokale Einträge werden nicht überschrieben.',
              ),
              actions: [
                TextButton(
                  onPressed: () => Navigator.pop(context, false),
  ...
  void _showBackupError(BackupException error) {
    final message = switch (error.failure) {
      ...
      BackupFailure.invalidFormat =>
        'Die ausgewählte Datei ist kein gültiges Strick & Häkelbuch-Backup.',
    };
...
class _BackupWorkOverlay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final detail = progress == null
        ...
        ? 'Fotos und Projektprotokolle werden zusammengestellt.'

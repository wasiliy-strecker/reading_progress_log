...
class EncryptedBackupService {
  ...
  static const extension = 'shbackup';
  static const _format = 'strick_haekelbuch_backup';
  ...
  Future<CreatedBackup> create(
    ...
    final file = File(
      p.join(directory.path, 'strick_haekelbuch_$stamp.$extension'),
    );
  ...
  Future<Map<String, dynamic>> _decryptLegacy(
    ...
    final envelope = await compute(
      _decodeBackupEnvelope,
      <String, dynamic>{
        'encodedEnvelope': encodedEnvelope,
        'format': _format,
        'maximumSchemaVersion': _maximumLegacyVersion,
      },
      debugLabel: 'Strick & Häkelbuch backup envelope decoding',
    );
    ...
    final decoded = await compute(
      ...
      clearText,
      debugLabel: 'Strick & Häkelbuch backup JSON decoding',
    );

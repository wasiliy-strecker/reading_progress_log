...
import 'package:strick_haekelbuch/app/widgets/confirm_dialog.dart';
                  ...
                  onPressed: () async {
                    result = discard
                        ? await confirmDiscardChanges(
                            ...
                            message:
                                'Die Änderungen an diesem Projektstand wurden noch nicht gespeichert.',
                          )
                        : await confirmDestructiveAction(
                            context,
                            title: 'Projekt löschen?',
                            message:
                                'Das Projekt mit allen Projektständen, Fotos und gespeicherten Projektprotokollen wird dauerhaft gelöscht.',
                          );
                  },

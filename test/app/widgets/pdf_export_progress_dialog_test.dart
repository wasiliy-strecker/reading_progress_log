...
import 'package:strick_haekelbuch/app/widgets/pdf_export_progress_dialog.dart';
...
void main() {
  testWidgets('PDF progress dialog blocks back and closes after completion', (
            ...
            builder: (context) => FilledButton(
              onPressed: () async {
                result = await runWithPdfExportProgress(
                  context,
                  description: 'Projektprotokolldaten werden zusammengestellt.',
                  operation: () {
    ...
    expect(find.text('Projektprotokoll wird erstellt'), findsNothing);
              ...
              onPressed: () async {
                try {
                  await runWithPdfExportProgress<void>(
                    context,
                    description:
                        'Projektprotokolldaten werden zusammengestellt.',

...
import 'package:strick_haekelbuch/app/widgets/app_actions.dart';
...
void main() {
          ...
          _app(
            ...
            child: Column(
              ...
              children: [
                ...
                TextButton(
                  onPressed: press,
                  child: const Text('Beispiele ansehen'),
                ),
  ...
  for (final scale in [1.0, 1.5, 2.0]) {
    testWidgets('long action text grows without clipping at scale $scale', (
      ...
      var tapped = false;
      const label = 'Projekt & Erinnerung bearbeiten';
      await tester.pumpWidget(
        _app(
          scale: scale,
          child: Align(
  ...
  for (final label in ['Projekt anlegen', 'Projektstand erfassen']) {
    for (final scale in [1.0, 1.5, 2.0]) {

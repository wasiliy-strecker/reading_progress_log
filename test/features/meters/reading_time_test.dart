...
import 'package:strick_haekelbuch/features/meters/presentation/editable_reading_time_card.dart';
...
void main() {
  ...
  testWidgets('future date is displayed normally and remains editable', (
    ...
    expect(find.text('Zeitpunkt des Projektstands'), findsOneWidget);

...
void main() {
  ...
  test('persists meter, reading and append-only revision', () async {
    ...
    await readings.updateWithRevision(
      ...
      ReadingRevision(
        ...
        reason: 'Tippfehler',
        changes: const {
          'Aktuelle Reihe': ReadingChange(before: '123,4', after: '124,0'),
        },
      ),
    );
  ...
  test(
    ...
    () async {
      ...
      expect(electricity.latestUnit, 'Reihen');
        ...
        batch.insertAll(database.meterRecords, [
          for (var meterIndex = 0; meterIndex < meterCount; meterIndex++)
            MeterRecordsCompanion.insert(
              ...
              label: 'Projekt $meterIndex',
              type: MeterType.knitting.name,
              unit: 'Reihen',
